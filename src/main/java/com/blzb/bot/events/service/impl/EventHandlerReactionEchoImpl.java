 ...
 */
@Service
public class EventHandlerReactionEchoImpl implements EventHandler {
    ...
    public EventTypeEnum getEventType() {
        return EventTypeEnum.REACTION_ADDED;
    }
    ...
    private void echoText(JsonNode payload) {
        postMessage(payload.get("event").get("item").get("channel").asText(), payload.get("event").get("reaction").asText());
    }
